1. Connect your device to the computer as shown in the [Connecting to a computer](Connecting to a computer.md) guide. Find the COM-port associated with the device.
